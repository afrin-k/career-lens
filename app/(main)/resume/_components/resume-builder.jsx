...
import { AlertTriangle, Backpack, Download, Edit, Loader2, Monitor, Save } from 'lucide-react';
...
const ResumeBuilder = ({initialContent}) => {
  ...
  const {
    ...
    register,
    handleSubmit,
    watch, // to update values in markdown simultaneously as we are entering in form
    formState: { errors },
  } = useForm({
